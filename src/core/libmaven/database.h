...
class Database
{
    public:
        ...
        /**
         * @brief addMascot_NISTCompound    Reads MSP and Mascot files and adds
         * the compound to its DB.
         * @param newCompound   Compound Object.
         * @return
         */
        bool addMascot_NISTCompound(Compound* newCompound);
